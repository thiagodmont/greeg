...
def report(args):
    ...
    out = ["# Benchmarks", "", "Generated by `bench/bench.py report` from `bench/results/`. Rows record the protocol version they were measured under; protocol 2 (2026-09-02) fixed the comparison to be like-for-like, and protocol 3 (2026-09-04) added the SCIP-covered useful-line ratio beside the strict one, changing no earlier number.", ""]
    if speed_res:
        h = speed_res["host"]
